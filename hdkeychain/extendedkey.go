...
import (
	...
	"github.com/wificoin-project/wfcutil/base58"
...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := wfcutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*wfcutil.AddressPubKeyHash, error) {
	pkHash := wfcutil.Hash160(k.pubKeyBytes())
	return wfcutil.NewAddressPubKeyHash(pkHash, net)
}
