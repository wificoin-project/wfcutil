...
/*
This test file is part of the wfcutil package rather than than the
wfcutil_test package so it can bridge access to the internals to properly test
...
import (
	...
	"github.com/wificoin-project/wfcutil/bech32"
