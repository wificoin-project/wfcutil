...
import (
	...
	"github.com/wificoin-project/wfcutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    wfcutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() wfcutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value wfcutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = wfcutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = wfcutil.NewTxFromBytes(testSimpleCoinTxBytes)
