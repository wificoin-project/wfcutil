...
// Tx returns a wrapped transaction (wfcutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (wfcutil.Tx) for all
...
// instead provides easy access to wrapped versions (wfcutil.Tx) of them.
